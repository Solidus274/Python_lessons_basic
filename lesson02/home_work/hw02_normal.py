...
numbers = [2, 6, 18, 14, 9, 426, 1024, 100, 110, 0, 725, 1]
numbers_finish = []

for i in numbers:
    if (math.sqrt(i)).is_integer():
        numbers_finish.append(int(math.sqrt(i)))
    else:
        continue

print(numbers_finish)
...
n = int(input("Введите количество произвольных элементов списка:"))
